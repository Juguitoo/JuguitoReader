...
| ID | Tarea | Estado | Ref |
|----|-------|--------|-----|
| DATA-001 | Separar INSERT / UPDATE en DAOs (Book, Folder, Genre) | `[ ]` | KNOWN_ISSUES |
...
| READER-003 | UpdateReadingProgressUseCase usa saveBook(REPLACE) → borra relaciones | `[ ]` | KNOWN_ISSUES |
...
<details>
<summary>v1.0.0 – v1.1.0 – v1.2.0 features (clic para expandir)</summary>
