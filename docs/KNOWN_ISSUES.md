...
| ---------- | ----------------------------------------------------------------------- | --------- | -------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| DATA-013   | BookDetail delete ignora `Result.failure`                               | Medio     | Abierto  | v1.2.0 | `DeleteBookUseCase` no lanza; `runCatching` trata el `Result` como éxito → borra ficheros y pop. (1)                                           |                    |
...
| FILE-010   | Confirm de delete en Home no borra `cache/reader`                       | Bajo      | Abierto  | v1.2.0 | Detail sí llama `deleteReaderCache`.                                                                                                           |                    |
