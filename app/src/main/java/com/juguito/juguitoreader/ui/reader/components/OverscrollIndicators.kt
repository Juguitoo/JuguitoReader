            ...
            AnimatedVisibility(
                ...
                Surface(
                    ...
                    Row(
                        ...
                        Text(
                            text = if (progress >= 1f) stringResource(R.string.release_to_return) else stringResource(
            ...
            AnimatedVisibility(
                ...
                Surface(
                    ...
                    Row(
                        ...
                        Spacer(modifier = Modifier.width(8.dp))
                        Text(
                            text = if (progress >= 1f) stringResource(R.string.release_to_advance) else stringResource(
