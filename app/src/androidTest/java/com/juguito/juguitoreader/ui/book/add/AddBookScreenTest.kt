...
class AddBookScreenTest {
    ...
    @Test
    fun addBookScreen_hides_epub_section_when_physical() {
        val state = AddBookUiState(
            bookDraft = BookDraftState(isPhysical = true)
        )
        ...
        composeTestRule.onNodeWithText(context.getString(R.string.reading_file)).assertDoesNotExist()
        composeTestRule.onNodeWithContentDescription(context.getString(R.string.autocomplete_epub))
            .assertDoesNotExist()
    }
}
